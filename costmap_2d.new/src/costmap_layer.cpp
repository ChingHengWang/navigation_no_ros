...
void CostmapLayer::matchSize()
{
    ...
    cout<<"CostmapLayer::matchSize()"<<endl;
    cout<<"CostmapLayer::matchSize() master->getSizeInCellsX() : "<<master->getSizeInCellsX()<<endl;
    cout<<"CostmapLayer::matchSize() master->getSizeInCellsY() : "<<master->getSizeInCellsY()<<endl;
    cout<<"CostmapLayer::matchSize() master->getOriginX() : "<<master->getOriginX()<<endl;
    cout<<"CostmapLayer::matchSize() master->getOriginY() : "<<master->getOriginY()<<endl;
    cout<<"CostmapLayer::matchSize() master->getResolution() : "<<master->getResolution()<<endl;
