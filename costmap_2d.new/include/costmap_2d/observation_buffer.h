...
public:
  ...
  ObservationBuffer(std::string topic_name, double observation_keep_time, double expected_update_rate,
                    ...
                    std::string sensor_frame, double tf_tolerance, nav_msgs::Odometry* robot_odom);
  ...
  double getObservationKeepTime()
  {
    return observation_keep_time_;
  }
  double getExpectedUpdateRate()
  {
