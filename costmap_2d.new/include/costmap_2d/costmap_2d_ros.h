...
//#include "Slam/TimestampedObject.h"
//#include "Slam/NotifyBuffer.h"

//ekf input
//#include "Slam/robot_pose_ekf.h"

//using namespace pepper_nav;
...
public:
  ...
  //Costmap2DROS(std::string name, bool isGlobalCostmap);
  Costmap2DROS(std::string name, nav_msgs::Odometry* robot_odom, bool isGlobalCostmap);
  ~Costmap2DROS();
...
private:
  ...
  //void resetOldParameters(bool bGlobal);
  void reconfigureCB();
  //void movementCB(const ros::TimerEvent &event);
  void movementCB(double time_sleep);
