...
public:
   ...
   */
  //void laserScanCallback(const boost::shared_ptr<costmap_2d::ObservationBuffer>& buffer);
   /**
  ...
  void laserScanCallback(const sensor_msgs::LaserScan& scan_in);
...
protected:
 // virtual void setupDynamicReconfigure(ros::NodeHandle& nh);
  ...
  //lock
  //boost::recursive_mutex odom_lock;
  //Odom buffer
