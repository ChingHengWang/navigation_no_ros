...
/* initial variable */
    ros::Publisher cmd_pub_ = n.advertise<geometry_msgs::Twist>("/andbot/cmd_vel", 1);
    ros::Subscriber pos_sub = n.subscribe("/andbot/odom_diffdrive", 1000, odomCallback);
...
/*while loop*/
    ...
    {  
        ...
        /* path = global_path(start ,end) */
            ...
            cmd->linear.x = mobile_delta_x;
            cmd->linear.y = mobile_delta_y;
            cmd->angular.z = mobile_delta_yaw;
