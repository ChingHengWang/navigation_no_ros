...
public:
   ...
   */
  bool stopWithAccLimits(const arc::PoseStamped& global_pose,
   ...
   * @return  True if a valid trajectory was found, false otherwise
   */
  bool rotateToGoal(const arc::PoseStamped& global_pose,
      const arc::PoseStamped& robot_vel,
      double goal_th,
      arc::Twist& cmd_vel,
      Eigen::Vector3f acc_lim,
  ...
  bool computeVelocityCommandsStopRotate(arc::Twist& cmd_vel,
      Eigen::Vector3f acc_lim,
      double sim_period,
