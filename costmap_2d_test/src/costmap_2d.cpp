...
//    fp=fopen("/home/lixiaopeng/pepper/costmap_2d_test/data/costdata.dat","w");
//    fp1=fopen("/home/lixiaopeng/pepper/costmap_2d_test/data/costdata3.dat","w");
//    fp2=fopen("/home/lixiaopeng/pepper/costmap_2d_test/data/costdata1.dat","w");
//    fp3=fopen("/home/lixiaopeng/pepper/costmap_2d_test/data/costdata.dat","w");
}
...
bool Costmap2D_Test::setConvexPolygonCost(const std::vector<Header::Point>& polygon, unsigned char cost_value)
{
...
void Costmap2D_Test::setFootprint(const std::vector<Header::Point>& footprint_spec)
{
